...
public class RemovePhoneNumberFromBusinessPartnerUseCaseTests
{
    [Fact]
    public async Task ExecuteAsync_ShouldRemovePhoneNumber_WhenItExists()
    {
        // Arrange
        ...
        var useCase =
            new RemovePhoneNumberFromBusinessPartnerUseCase(repository);
    ...
    [Fact]
    public async Task ExecuteAsync_ShouldReturnFalse_WhenPhoneNumberDoesNotExist()
    {
        // Arrange
        var businessPartner = new BusinessPartner(
            "Agro Teste Ltda",
